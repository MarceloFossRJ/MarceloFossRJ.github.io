...
date:   2019-02-17 18:44:25 -0300
category: [cheatsheet]
tags: [jekyll, ruby, blog, cheatsheet]
author: Marcelo Foss
intro: |
---
...
- [Global, Site and Page Variables](#global-variables)
- [Liquid Template Filters and Tags](#liquid-template-filters-and-tags)
...
These variables let you use the complete `user/repository` the objects in Jekyll, thus,
...
Adding the [jekyll-sitemap gem](https://github.com/jekyll/jekyll-sitemap)  to your site's configuration (`_config.yml`) e.g.
